...
import api.check_camera as check_camera
import api.Capture_Image as Capture_Image
import api.Train_Image as Train_Image
...
root = Tk()  
root.title("AI in Attendance System")
tkID = tk.StringVar()
tkName = tk.StringVar()
...
id_label = tk.Label(root,
        text='Reg ID:', bd=2, bg='#eeeeee',
        anchor=tk.W, relief="solid")
id_label.grid(
    padx=12,
    pady=(8, 0),
    ipadx=0,
